public class Demo6_D {
    public static void main(String[] args) {
        ...
        String line1 = YELLOWCOLOR+"-".repeat(10)+RESET;
        String line2 = YELLOWCOLOR+"-".repeat(7)+RESET;
        String GreenLine1 = GREENCOLOR+"-".repeat(10)+RESET;
        String GreenLine2 = GREENCOLOR+"-".repeat(7)+RESET;
        ...
        String quantityApples = BLUECOLOR+"5 "+RESET;
        String quantityoranges = BLUECOLOR+"10 "+RESET;


        String priceApples = GREENCOLOR+"$"+RESET+PINKCOLOR+"0.99 "+RESET;
        String priceOranges = GREENCOLOR+"$"+RESET+PINKCOLOR+"1.49 "+RESET;
        ...
        System.out.printf("%s%-10s%1$s%19s%1$s%25s%1$s\n", devider2,item1,quantityApples,priceApples);
        System.out.printf("%s%-10s%1$s%19s%1$s%25s%1$s\n", devider2,item2,quantityoranges,priceOranges);
        System.out.printf("%s%s%1$s%s%1$s%s%1$s\n", devider1,GreenLine1,line1,GreenLine2);
